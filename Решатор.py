...
while user_chose != '0':
    if user_chose == '1':
        ...
        if user_chose == 1:
            ...
            elems_count = int(input())

            print("Получившая арифметическая прогрессия:")
            print(elem, end=' ')
       
            for _ in range(elems_count - 1):
                elem += step
                print(elem, end=' ')
            print()
        elif user_chose == 2:
            ...
            if elem == elem_need:
                ...
                print(
                    f"Элемент со значением {elem_need} находится под номером {elems_counter}"
                )
            else:
        ...
        print("Это явно не число или неправильный номер пункта!")
